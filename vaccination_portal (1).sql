...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2026 at 07:35 PM
...
INSERT INTO `hospital_requests` (`id`, `parent_id`, `child_id`, `requested_hospital`, `status`, `created_at`) VALUES
(1, 1, 4, 'Aptech Mental Hospital', 'Pending', '2026-02-02 14:21:23');
...
INSERT INTO `parents` (`parent_id`, `parent_name`, `email`, `password`) VALUES
(1, 'Ahmed', 'sameerqadeer167@gmail.com', '');
...
INSERT INTO `requests` (`id`, `parent_name`, `message`, `status`) VALUES
(1, 'Sameer', 'Need vaccine appointment', 'approved');
...
(5, 'sameer', 'sameerqader70@gmail.com', '$2y$10$84Jku.y7s4Cj3TUeJ1iKoezz0pXGklK3vDWOg5qHNn3eWWodCjE1m', 'admin'),
(6, 'sameer', 'sameerqader70@gmail.com', '$2y$10$pr/K.opXqP/iFKylvb2t2.pZpt5tdDHvgKKSe.uIdStTTOyfGtUqi', 'parent'),
(7, 'Ahmed', 'sameerqadeer167@gmail.com', '$2y$10$gGS0FyKs6n0wBSWcXaM0Sut1fRIMigUeMdlO461.fe4d8q54oV8e2', 'parent'),
(8, 'Aptech Mental Hospital', 'muhammad.sameer.waada0@gmail.com', '$2y$10$RbiXBAQubRJus2v.cO6n2uL668VBg0x44FC1TEEVcHy6VmyKyLHLm', 'hospital'),
(9, '.', 'sameerqader70@gmail.com', '$2y$10$zcODHeG5pNeQ6TryxX8wZeTBNItfuiN6yaNIpotrZQWC62LZacMCe', 'admin');
